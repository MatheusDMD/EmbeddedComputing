...
void RTC_Handler(void)
{
	...
	if ((ul_status & RTC_SR_SEC) == RTC_SR_SEC) {
		...
		if ((ul_status & RTC_SR_ALARM) == RTC_SR_ALARM) {
			...
			rtc_get_time(RTC,hour,minuto,second);
			rtc_set_time_alarm(RTC, 1, *hour, 1, *minuto+1, 1, *second+10);
		}
	}
...
int main(void){
    ...
    rtc_get_time(RTC,hour,minuto,second);
	rtc_set_time_alarm(RTC, 1, *hour, 1, *minuto, 1, *second+10);
